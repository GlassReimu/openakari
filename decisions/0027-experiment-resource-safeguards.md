...
3. **run.py waste-ratio guard**: Implementation task for `projects/akari/` Next Actions
4. **Experiment script --resume-validate**: Implementation task for `projects/sample-project/` Next Actions
5. **Experiment runner test suite**: Implementation task for `projects/akari/` Next Actions
6. **Orient ledger reconciliation**: Implementation task for `projects/akari/` Next Actions
