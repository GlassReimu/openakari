...
Implementation: `projects/akari/plans/fleet-bootstrap-implementation.md`
Tasks: `projects/akari/TASKS.md` § Heterogeneous Agent Fleet

## Context

akari currently runs autonomous sessions sequentially via a single cron job (every 30
...
────────────────────────────────────────
You are a fleet worker in the akari research system.
...
akari's mission is to achieve fully autonomous research through self-evolution and
...
Evaluated against these axioms, V2 better aligns with akari's mission on three axes:

**1. Knowledge value over throughput.**
akari's core metric is findings per dollar, not sessions per day or GPU utilization.
...
akari is not just a task-completion engine — it is a research contribution about how to
