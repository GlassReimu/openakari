...
- `projects/akari/analysis/glm-utilization-maximization-2026-03-05.md`
- `projects/akari/diagnosis/diagnosis-fleet-idle-exploration-zero-knowledge-2026-03-03.md`
- `projects/akari/diagnosis/diagnosis-fleet-starvation-all-blocked-2026-03-04.md`

## Context

ADR 0042-v2 established akari's fleet architecture: 1 Opus supervisor + up to 32 GLM-5
...
Source: `projects/akari/diagnosis/diagnosis-fleet-idle-exploration-zero-knowledge-2026-03-03.md`
...
- **Empirically grounded**: Design derived from akari's own benchmark data AND
