...
Akari currently acquires external knowledge about GenAI developments only through:
...
How to make Akari capable of not relying on human input to supply this knowledge?"

This is a strategic gap. Akari's mission is fully autonomous research, but knowledge
...
1. **Create a `/horizon-scan` skill** for periodic autonomous scanning of GenAI
   ...
   announcements, benchmark results, and research papers relevant to akari's active
...
5. **Scope is bounded by active projects.** Horizon-scan does not do open-ended
   ...
   - Models used by akari (Claude, Gemini, GPT families)
...
- Akari gains the ability to proactively discover new GenAI developments without
