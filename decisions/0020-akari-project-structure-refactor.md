...
Status: accepted
Supersedes: original 0020 (akari-only scope, 2026-02-19)

## Context

The original ADR 0020 (2026-02-19) addressed directory clutter in `projects/akari/`
...
|---------|-------------|---------------------------------------------|-------------|-------------------|
| akari | 523 (down from 2,098 after partial migration) | 37 files | yes (created) | no |
| sample-project | 2,128 (~1,900 lines of log) | 1 file | no | no |

The akari project partially implemented the original ADR: `log/` was created and
