...
akari was created on 2026-02-14. In 14 calendar days it accumulated 1600+ commits, 7
...
1. **Temporal claims require mechanical verification.** Any claim about duration, age,
   timeline, or temporal sequence in akari artifacts must be derived from verifiable
...
2. **Verification procedure.** When writing a temporal claim:
   ...
   - State the source inline: "akari has operated for 14 days (first commit: 2026-02-14)"

3. **Anti-pattern: human-timescale reasoning.** Do not reason about akari operations
...
4. **Agentic timescale awareness.** When describing akari's operational characteristics,
