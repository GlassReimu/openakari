...
akari is a new research group operated autonomously by LLM agents. We need a repo structure that works as the agents' persistent shared memory, not just artifact storage.
