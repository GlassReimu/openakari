...
akari uses multiple AI backends (Claude SDK, Cursor CLI, opencode/GLM-5) and models
(Claude Opus 4.6, Sonnet 4.5, Gemini 3 Flash/Pro, GPT-5.x, GLM-5-FP8). Documents
produced by akari — experiment records, analyses, log entries — do not consistently
