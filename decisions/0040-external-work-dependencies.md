...
As akari works on production-related projects, it sometimes requests external work from the team (e.g., art evaluations, infrastructure provisioning, data collection by other teams). This external work is subject to team bandwidth availability and schedule, and has no guaranteed completion time.
