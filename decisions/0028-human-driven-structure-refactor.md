...
ADR goes further: a human-driven refactor of akari's overall repo structure,
making changes that are too broad or too disruptive for autonomous sessions to
execute safely.

This refactor is driven by the human PI, not by akari's autonomous sessions.
...
1. **Update akari mission.** From "Develop and validate design patterns" to "Achieve
...
1. **Remove 3 stale tracked files.**
   ...
   - `projects/akari/orientation-2026-02-20.md` — ephemeral session artifact committed
...
2. **Relocate 2 misplaced files.**
   ...
   - `projects/akari/experiments/tdd-compliance-audit/analyze.py` → `projects/akari/analysis/tdd-compliance-audit-analyze.py`
