...
Three recurring failure modes from the original akari system are useful to preserve:
...
This file is adapted from the original akari repo's self-observation diagnosis. It is included as an example of how the meta-project turns operational failures into research artifacts.
