...
cat ~/akari/infra/scheduler/ecosystem.config.cjs | grep FLEET_SIZE
...
- Diagnosis: `projects/akari/diagnosis/diagnosis-opencode-fleet-total-failure-2026-03-06.md`
