Akari's fleet is an operational research system: many concurrent autonomous sessions, coordinated by infrastructure, producing measurable engineering and research output with sparse human intervention.
...
If you want the pattern and trade-offs, read `decisions/0042-v2-persistent-subagent-fleet.md` and `projects/akari/patterns/autonomous-execution.md`.

## Evidence: sustained autonomous operation

The source system that openakari was extracted from operated an always-on fleet for weeks. The most useful evidence is not a demo run; it is the distribution of outcomes over thousands of autonomous sessions.
...
This is the autonomy claim openakari is willing to make:
...
In Akari, the agentic software process is instrumented and studied:
...
Openakari is designed to make that loop legible and portable.
